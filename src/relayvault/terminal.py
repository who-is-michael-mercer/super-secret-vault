...
class Terminal:
    ...
    def __init__(
        ...
        *,
        ...
        self.width = (
            width if width is not None else shutil.get_terminal_size((80, 24)).columns
        )
    ...
    def progress(
        self, label: str, duration: float, width: int = 20, *, skippable: bool = True
    ) -> None:
